 ...
 */
header("Content-Type: text/html; charset=utf-8");  /**UTF-8 para asentuação */
 ...
 */
date_default_timezone_set("America/Sao_Paulo");  /**nosso horario padrão */
set_error_handler("fullStackPHPErrorHandler");   /**não tera os erros naturais do php */
